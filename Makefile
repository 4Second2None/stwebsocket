...
LOCAL_FLAG = -O3 -fPIC -shared -I ./state-threads/obj -I ./

CLITEST_LDFLAG =  ./libst.a ./libcws.a -I ./ -I ./client -I ./state-threads/obj
SERTEST_LDFLAG =  ./libst.a ./libsws.a -I ./ -I ./server -I ./state-threads/obj
